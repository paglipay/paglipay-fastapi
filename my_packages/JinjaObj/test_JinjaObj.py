...
class Test_JinjaObj(unittest.TestCase):
    ...
    def test_Dtree(self):
        ...
        self.assertEqual(json.load(open('my_packages/JinjaObj/json/out.json')), d.data['my_packages/JinjaObj/json/out.json'])   
        self.assertEqual(yaml.safe_load(open('my_packages/JinjaObj/json/out.yml')), d.data['my_packages/JinjaObj/json/out.yml'])    
